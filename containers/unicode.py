...
class NormalizedStr:
    ...
    def __contains__(self, substr):
        ...
        '''
        substr_norm = unicodedata.normalize(self.norm, substr)
        return str(self.text).__contains__(str(substr_norm))
    ...
    def __add__(self, b):
        ...
        '''
        selfnorm = unicodedata.normalize(self.norm, str(b))
        addednorm = unicodedata.normalize(self.norm, self.text + selfnorm)
        return NormalizedStr(addednorm, self.norm)
