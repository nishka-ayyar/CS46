...
It is crucial to get these implemented correctly in order to be able
...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        a reference on how
        to write recursive functions on recursive data structures.
        '''
    ...
    def to_list(self, traversal_type):
        ...
        if traversal_type == 'preorder':
            ...
            return ValueError('Traversal Type ' + str(traversal_type) +
                              ' is not supported.')
